...
Backg2->backgroundPos.x=100;
	Backg2->backgroundPos.y=200;
	Backg2->backgroundPos.w=2*SCREEN_W;
	Backg2->backgroundPos.h=2*SCREEN_H;
}
...
void display_background(Background Backg,Background Backg2,SDL_Surface *screen)
{
	...
	SDL_BlitSurface(Backg.backgroundImg, &(Backg2.backgroundPos), screen,NULL); 
}
